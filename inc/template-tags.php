 ...
 * @package reason
 */
if ( ! function_exists( 'reason_s_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function reason_s_posted_on() {
...
if ( ! function_exists( 'reason_s_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function reason_s_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'reason_s_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function reason_s_entry_footer() {
...
if ( ! function_exists( 'reason_s_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function reason_s_post_thumbnail() {
